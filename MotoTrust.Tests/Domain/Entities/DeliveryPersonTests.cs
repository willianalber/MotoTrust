...
public class DeliveryPersonTests
{
    ...
    [Fact]
    public void CreateDeliveryPerson_WithNullIdentificador_ShouldThrowException()
    {
        // Arrange & Act & Assert
        var action = () => new DeliveryPerson(null!, "João da Silva", "12345678901234", 
            new DateTime(1990, 1, 1), "12345678900", LicenseType.A);
    ...
    [Fact]
    public void CreateDeliveryPerson_WithNullNome_ShouldThrowException()
    {
        // Arrange & Act & Assert
        var action = () => new DeliveryPerson("entregador123", null!, "12345678901234", 
            new DateTime(1990, 1, 1), "12345678900", LicenseType.A);
        action.Should().Throw<ArgumentNullException>()
